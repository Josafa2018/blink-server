...
module cc.blynk.core {
    ...
    requires transitive cc.blynk.server.notifications.mail;
    requires transitive cc.blynk.server.notifications.push;
    requires transitive cc.blynk.server.notifications.sms;
    requires transitive cc.blynk.server.notifications.twitter;
